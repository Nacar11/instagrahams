    ...
    >
        ...
        >
            ...
            >
                ...
                <button
                    @click="createPost()"
                    class="text-lg text-blue-500 hover:text-gray-900 font extrabold cursor-pointer"
                >
                    Share
                </button>
            </div>
                ...
                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    ...
                    <div class="flex w-full max-h-[200px] bg-white border-b">
                        <textarea
                            ...
                            rows="10"
                            class="placeholder-gray-500 w-full border-0 mt-2 mb-2 z-50 focus:ring-0 text-gray-600 tex-[18px]"
                        >
                        </textarea>
                    </div>
