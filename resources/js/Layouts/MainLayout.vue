...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        <div
            id="SideNav"
            class="fixed h-full bg-white xl:w-[200px] w-[80px] md:block hidden border-r border-r-gray-300"
        >
            <Link href="/">
                <img
            ...
            <div class="px-3">
                <Link href="/">
                    <MenuItem iconString="Home" class="mb-4"></MenuItem>
                </Link>
                <MenuItem iconString="Search" class="mb-4"></MenuItem>
                <MenuItem iconString="Explore" class="mb-4"></MenuItem>
